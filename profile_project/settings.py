...
SECRET_KEY = '!1+9s)%5vy_0m9b#^(n9$#=x-l0g3wo-ak(&3(^k9x0969x+ms'
...
AUTH_USER_MODEL = 'profile_api.UserProfile' #it will look into project_api folder and in models.py file
